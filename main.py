...
def generateCode():
    ...
    messagebox.showinfo("Jake's Code Generator", "QR Code is saved successfully!")


# Label for the window
headingFrame = Frame(wn, bg="azure", bd=5)
headingFrame.place(relx=0.15, rely=0.05, relwidth=0.7, relheight=0.1)
headingLabel = Label(headingFrame, text="Jake's QR Code Generator", bg='yellow', font=('Centruy', 20, 'bold'))
...
lable2 = Label(Frame2, text="Enter the location to save the QR Code: ", bg="SteelBlue3", fg='azure',
...
lable3 = Label(Frame3, text="Enter the name of the QR Code: ", bg="SteelBlue3", fg='azure',
               font=('Courier', 13, 'bold'))
...
lable4 = Label(Frame4, text="Enter the size from 1 to 40 with 1 being 21x21: ", bg="SteelBlue3", fg='azure',
               font=('Courier', 13, 'bold'))
